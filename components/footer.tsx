    ...
    <footer className="bg-slate-900 text-white">
      <div className="container mx-auto px-4 py-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-slate-300">123 Medical Research Blvd, Suite 456, San Francisco, CA 94107</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-slate-300">info@quantumdiagnose.com</span>
              </li>
        ...
        <div className="border-t border-slate-800 mt-12 pt-6 text-center text-sm text-slate-400">
          <p>© {new Date().getFullYear()} QuantumDiagnose. All rights reserved.</p>
          <p className="mt-2">
